...
Esta pasta contem o documento consolidado que comprova a execucao real do projeto Solar Shield, mapeado aos criterios da disciplina.

## Conteudo

- `GS-Microservice-Evidencias.docx` — documento consolidado com todas as evidencias (11 prints com legendas, explicacoes e mapeamento aos criterios de avaliacao)
